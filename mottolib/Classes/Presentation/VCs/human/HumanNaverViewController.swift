...
//            make.bottom.equalTo(self.view.safeAreaLayoutGuide).inset(5)
        ...
        let urlString = Domains.campaignURL + "main_human_naver.php?pk=" + Motto.pubkey + "&uid=\(Motto.uid)&pcode=\(String(describing: Motto.pcode))&campaignType=\(String(describing: Motto.adrole))&executionType=\(String(describing: Motto.jmethod))"
