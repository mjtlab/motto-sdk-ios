//
//  SiteTrafficViewController.swift
//  mottoapp
//
...
class SiteTrafficViewController: BaseCampaignViewController {
    ...
    let backButton = UIButton().then {
        ...
        $0.setImage(Utils.podImage(context: SiteTrafficViewController.self, img: "ic_arrow_left"), for: .normal)
        $0.translatesAutoresizingMaskIntoConstraints = false
    }
...
//        issueTimer?.invalidate()
    ...
    override func viewDidLoad() {
        ...
        let urlString = Motto.currentDomain + Global.campaignURL + Global.SiteTrafficController + "?pk=" + Motto.pubkey + "&uid=\(Motto.uid)&pcode=\(String(describing: Motto.pcode))&campaignType=\(String(describing: Motto.adrole))&executionType=\(String(describing: Motto.jmethod))"
