...
//        issueTimer?.invalidate()
    ...
    override func viewDidLoad() {
        ...
        let urlString = Domains.campaignURL + "main_site_traffic.php?pk=" + Motto.pubkey + "&uid=\(Motto.uid)&pcode=\(String(describing: Motto.pcode))&campaignType=\(String(describing: Motto.adrole))&executionType=\(String(describing: Motto.jmethod))"
