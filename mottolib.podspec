...
Pod::Spec.new do |s|
  s.name             = 'mottolib'
  s.version          = '0.1.0'
  s.summary          = 'A short description of mottolib.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/daybreaker48/mottolib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'daybreaker48' => 'prof.dagian@gmail.com' }
  s.source           = { :git => 'https://github.com/daybreaker48/mottolib.git', :tag => s.version.to_s }
